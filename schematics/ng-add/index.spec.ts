...
describe('ng-add Schematic', () => {
    ...
    it('should update package.json', async () => {
        workspaceTree = await schematicRunner.runSchematicAsync('ng-add', baseOptions, tree).toPromise();
    ...
    it(`should add icons`, async () => {
        workspaceTree = await schematicRunner.runSchematicAsync('ng-add', { ...baseOptions, icon: true }, tree).toPromise();
    ...
    it(`should not icons`, async () => {
        workspaceTree = await schematicRunner.runSchematicAsync('ng-add', { ...baseOptions, icon: false }, tree).toPromise();
