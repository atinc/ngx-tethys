import { isButtonAppearanceTarget, migrateButtonAppearance } from './button-appearance-migration';
...
describe('migrateButtonAppearance', () => {
    ...
    it('should migrate outline-* to thyAppearance="outline"', () => {
        ...
        expect(migrateButtonAppearance(content)).toBe(`<button thyButton="primary" thyAppearance="outline">Primary</button>`);
    });

    it('should migrate link-secondary to link + default', () => {
        const content = `<button thyButton="link-secondary" class="cancel">Cancel</button>`;
        expect(migrateButtonAppearance(content)).toBe(`<button thyButton="default" thyAppearance="link" class="cancel">Cancel</button>`);
    });
    ...
    it('should migrate bound literal compound values', () => {
        ...
        expect(migrateButtonAppearance(content)).toBe(`<button [thyButton]="'danger'" thyAppearance="outline">Danger</button>`);
    });
    ...
    it('should migrate bare link to link + primary', () => {
        ...
        expect(migrateButtonAppearance(content)).toBe(`<button thyButton="primary" thyAppearance="link">Link</button>`);
    });
    ...
    it('should migrate outline-primary-square to outline + primary', () => {
        ...
        expect(migrateButtonAppearance(content)).toBe(`<button thyButton="primary" thyAppearance="outline">Ok</button>`);
    });
    ...
    it('should keep thySize when migrating compound button type in batch-style edits', () => {
        ...
        expect(migrateButtonAppearance(content)).toBe(`<button thyButton="primary" thyAppearance="outline" thySize="lg">Ok</button>`);
    });
    ...
    it('should migrate duplicate compound type attributes in one pass', () => {
        ...
        expect(migrateButtonAppearance(content)).toBe(`<button thyButton="default" thyAppearance="link">Cancel</button>`);
    });
