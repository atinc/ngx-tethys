...
import { TethysVersionChanges, getTethysChangesForTarget } from '../core/target-version';
...
export function getTethysVersionUpgradeData<T extends keyof TethysUpgradeData, U = TethysVersionChanges<TethysUpgradeData[T]>>(
    ...
    return getTethysChangesForTarget<U>(migration.targetVersion, migration.upgradeData[dataName] as unknown as TethysVersionChanges<U>);
}
