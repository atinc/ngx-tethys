export const namePackageRelationsInNg13 = {
    ...
    FileSelectBaseComponent: 'uploader',
    ThyFileSelectComponent: 'uploader',
    ThyUploaderModule: 'uploader',
    ThyFileSizeExceedsContext: 'uploader',
    ThySizeExceedsHandler: 'uploader',
    ThyFileSelectEvent: 'uploader',
    ThyUploaderConfig: 'uploader',
    THY_UPLOADER_DEFAULT_OPTIONS: 'uploader',
    THY_UPLOADER_DEFAULT_OPTIONS_PROVIDER: 'uploader',
    sizeExceedsHandler: 'uploader',
    ThyUploadStatus: 'uploader',
    ThyUploadResponse: 'uploader',
    ThyUploadFileProgress: 'uploader',
