...
const NAME_PACKAGE_RELATION = {
    ...
    THY_MESSAGE_DEFAULT_CONFIG: 'message',
    THY_MESSAGE_DEFAULT_CONFIG_PROVIDER: 'message',
    ThyMessageComponent: 'message',
    ThyMessageContainerComponent: 'message',
    ThyMessageModule: 'message',
    ThyMessageService: 'message',
    ThyMessageConfig: 'message',
    ThyGlobalMessageConfig: 'message',
    ThyMessageRef: 'message',
    ThyMessageType: 'message',
