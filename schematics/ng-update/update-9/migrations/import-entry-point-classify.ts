...
const NAME_PACKAGE_RELATION = {
    ...
    dispatchEvent: 'core',
    dispatchFakeEvent: 'core',
    dispatchKeyboardEvent: 'core',
    dispatchMouseEvent: 'core',
    dispatchTouchEvent: 'core',
    patchElementFocus: 'core',
    createMouseEvent: 'core',
    createTouchEvent: 'core',
    createKeyboardEvent: 'core',
    createFakeEvent: 'core',
    bypassSanitizeProvider: 'core',
    defaultInlineIconSet: 'core',
    defaultSvgHtml: 'core',
    injectDefaultSvgIconSet: 'core',
    typeInElement: 'core',
    ThyTranslate: 'core',
