...
describe('ThyIconComponent', () => {
    ...
    describe('Basic', () => {
        let fixture: ComponentFixture<ThyIconTestBasicComponent> | undefined = undefined;
        let componentInstance: ThyIconTestBasicComponent | undefined = undefined;
        let iconDebugElement: DebugElement | undefined = undefined;
...
describe('IconRegistry', () => {
    let iconRegistry: ThyIconRegistry | undefined = undefined;
    let domSanitizer: DomSanitizer | undefined = undefined;
    let svgRandomName: string | undefined = undefined;
    let httpClientSpy: { get: jasmine.Spy } | undefined = undefined;
...
describe('Config', () => {
    let originalWhetherPrintErrorWhenIconNotFound: boolean | undefined = undefined;
