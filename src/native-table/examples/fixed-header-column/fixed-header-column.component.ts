...
@Component({
    selector: 'thy-native-table-fixed-header-column-example',
    templateUrl: './fixed-header-column.component.html',
    imports: [ThyNativeTableModule, ThyInputModule, FormsModule, ThyIcon]
})
export class ThyNativeTableFixedHeaderColumnExampleComponent implements OnInit {
    data = [
