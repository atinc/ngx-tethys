...
describe('skeleton ', () => {
    ...
    fit('should set children style by parent parameter when child parameter is null', () => {
        ...
        console.log(getComputedStyle(circleElement).getPropertyValue('width'), rectangleElement);
    });

    fit('should set children style by it"s own parameter', () => {
        fixture.detectChanges();
