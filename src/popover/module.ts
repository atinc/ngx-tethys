...
@NgModule({
    imports: [CommonModule, OverlayModule, PortalModule, ThyIconModule, ThyPopoverContainerComponent, ThyPopoverDirective, ThyPopoverHeaderComponent, ThyPopoverBodyComponent],
