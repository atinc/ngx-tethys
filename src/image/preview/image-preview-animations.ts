...
const animationBody = [
    ...
    // specifying the transform explicitly, causes IE both to blur the image preview content and
 ...
 * @docs-private
 */
export const thyImagePreviewAnimations: {
    readonly imagePreviewContainer: AnimationTriggerMetadata;
} = {
    imagePreviewContainer: trigger('imagePreviewContainer', animationBody)
};
