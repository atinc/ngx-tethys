...
describe('ThyStepperNext', () => {
    let fixture: ComponentFixture<ThyStepperButtonDirectiveComponent> | undefined = undefined;
    let thyStepperComponent: MockThyStepperComponent | undefined = undefined;
