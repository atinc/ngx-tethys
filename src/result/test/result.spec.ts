...
describe('ThyResult', () => {
    let fixture: ComponentFixture<ThyResultDemoComponent> | undefined = undefined;
    let testComponent: ThyResultDemoComponent | undefined = undefined;
    let thyResultComponent: DebugElement | undefined = undefined;
