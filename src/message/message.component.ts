import { Component, Input, HostBinding, NgZone, ApplicationRef, ViewChild, ElementRef } from '@angular/core';
import { trigger, state, style, animate, transition } from '@angular/animations';
import { ThyMessageConfig } from './message.config';
import { ThyMessageQueue } from './message-queue.service';
import { ANIMATION_IN_DURATION, ANIMATION_OUT_DURATION, HIDE_STYLE, ThyMessageBaseComponent } from './base';
...
export class ThyMessageComponent extends ThyMessageBaseComponent {
    ...
    constructor(ngZone: NgZone, messageQueue: ThyMessageQueue, applicationRef: ApplicationRef) {
        super(ngZone, messageQueue, applicationRef);
    }
}
