import { ChangeDetectionStrategy, Component, model, input, output, Signal, effect, TemplateRef, inject } from '@angular/core';
...
export class InnerPopup {
    ...
    onChooseMonth(value: TinyDate): void {
        ...
        this.activeDate.set(this.activeDate().setMonth(value.getMonth()));
    ...
    onChooseQuarter(value: TinyDate): void {
        const endPanelMode = this.endPanelMode();
        this.activeDate.set(this.activeDate().setQuarter(value.getQuarter()));
    ...
    onChooseYear(value: TinyDate): void {
        const endPanelMode = this.endPanelMode();
        this.activeDate.set(this.activeDate().setYear(value.getYear()));
