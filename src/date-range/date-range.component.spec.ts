...
describe('ThyTestDateRangeComponent', () => {
    ...
    describe('general api testing', () => {
        ...
        it('should open by click and close by click at outside', fakeAsync(() => {
            ...
            console.log(getPickerTriggerWrapper());
            dispatchMouseEvent(getPickerTriggerWrapper(), 'click');
            fixture.detectChanges();
            tick(500);
            fixture.detectChanges();
            console.log(getPickerContainer());
        ...
        it('should support thyPlaceHolder', () => {
            ...
            expect(getPickerTriggerWrapper()).toContain(value);
        });
        */
        /**
...
*/
    ...
    function getPickerContainer(): HTMLElement {
        return queryFromOverlay('.cdk-overlay-container') as HTMLElement;
    }
...
@Component({
    template: `
        <ng-container [ngSwitch]="useSuite">
            ...
            <thy-date-range *ngSwitchCase="2"></thy-date-range>

            <!-- Suite 3 -->
            <thy-date-range *ngSwitchCase="3" [(ngModel)]="modelValue"></thy-date-range>
        </ng-container>
    `
})
