...
@NgModule({
    declarations: [PopBoxContainerComponent, ThyPopBoxHeader, ThyPopBoxBody, ThyPopBoxFooter, ThyPopBoxTriggerDirective],
    entryComponents: [PopBoxContainerComponent],
    imports: [CommonModule, ThySharedModule],
    exports: [ThyPopBoxHeader, ThyPopBoxBody, ThyPopBoxFooter, ThyPopBoxTriggerDirective],
    providers: [ThyPopBoxService, PopBoxRef, ComponentLoaderFactory]
})
