...
export class ThyNotifyService {
    ...
    private _topLeftQueue: ThyNotifyOption[] = [];
    private _topRightQueue: ThyNotifyOption[] = [];
    private _bottomLeftQueue: ThyNotifyOption[] = [];
    private _bottomRightQueue: ThyNotifyOption[] = [];
