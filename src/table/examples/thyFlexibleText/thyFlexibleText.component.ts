...
@Component({
    selector: 'thy-table-thy-flexible-text-example',
    templateUrl: './thyFlexibleText.component.html',
    host: {
        class: 'd-block w-100'
    },
    imports: [ThyTable, ThyTableColumnComponent, ThyButton]
})
export class ThyTableThyFlexibleTextExampleComponent implements OnInit, AfterViewInit, OnDestroy {
