...
function transformContent(source) {
    // Only change standalone let declarations with a type annotation and no initializer.
    // Avoid changing lines that already have an initializer (`=`) or are not simple statements.
    // We process line by line semantics via regex across content safely.
